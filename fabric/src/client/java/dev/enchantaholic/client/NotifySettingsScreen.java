...
/** Enchant sound / enchant message ON|OFF and Done. Every toggle is saved right away. Opened from Mod Menu. */
public class NotifySettingsScreen extends Screen {
	...
	public NotifySettingsScreen(@Nullable Screen parent) {
		super(Component.translatable("enchantaholic.settings.title"));
		this.parent = parent;
	}
